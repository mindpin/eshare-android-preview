...
public abstract class EsharePostRequest<TResult> extends EshareHttpRequest<TResult> {
  
    public EsharePostRequest(final String request_path, final HttpParam... param) {
    ...
    private HttpPost build_http_post(HttpEntity entity, String request_path) {
        HttpPost http_post = new HttpPost(EshareHttpRequest.SITE + request_path);
        System.out.println("http_post " + EshareHttpRequest.SITE + request_path);
