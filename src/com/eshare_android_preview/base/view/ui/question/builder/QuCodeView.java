...
import com.eshare_android_preview.base.view.ui.question.QuestionFillSpan;
import com.eshare_android_preview.base.view.ui.question.code.RichCodeTextView;
...
public class QuCodeView extends RichCodeTextView implements IQuItemView {
    public QuCodeView(Context context, Question.ContentToken token) {
        super(context);
